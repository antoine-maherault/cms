     ...
     <?php
      ...
      <div class="site-info">
    	<?php
                ...
                printf( esc_html__( '%1$s By aThemeArt - Proudly powered by WordPress.', 'business-consultant-finder' ), '<a href="https://athemeart.net/downloads/business-consultant-finder/" target="_blank" rel="nofollow">Business Consultant Finder Theme</a>' );
                ?>
      </div>
